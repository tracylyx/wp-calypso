...
const getMonthlyTimeframe = ( discount ) => ( {
	...
	// Translators:  the following text will be like "Save 43% by paying annually"
	getUpsellCopyForTest: () =>
		translate( 'Save %(discount)s by paying annually', { args: { discount } } ),
} );
